...
--Please notice that is it the responsibility of the invoker of this function to compare the resulting organisationenhed_registration (including the entire hierarchy)
...
--Also notice, that the given array of OrganisationenhedAttr...Type must be consistent regarding virkning (although the allowance of null-values might make it possible to construct 'logically consistent'-arrays of objects with overlapping virknings)
...
AND (a.brugervendtnoegle IS NULL OR a.brugervendtnoegle='') AND (a.enhedsnavn IS NULL OR a.enhedsnavn='')
;
