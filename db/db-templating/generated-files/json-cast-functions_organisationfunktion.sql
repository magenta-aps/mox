...
/*
NOTICE: This file is auto-generated using the script: apply-template.py organisationfunktion json-cast-functions.jinja.sql
*/
...
(
  ...
  tils as (
    ...
    FROM 
      ( 
        ...
        CASE 
        WHEN coalesce(array_length($1.tilsGyldighed,0),0)>0 THEN to_json($1.tilsGyldighed) 
        ELSE 
        NULL
  ...
  rel as (
    ...
    (
      SELECT
      e.relType,
      array_agg( _json_object_delete_keys(row_to_json(ROW(e.relType,e.virkning,e.relMaalUuid,e.relMaalUrn,e.objektType)::OrganisationfunktionRelationType),ARRAY['reltype']::text[])) rel_json_arr
...
--drop cast (OrganisationfunktionRegistreringType as json);
...
--drop cast (OrganisationfunktionType as json);
