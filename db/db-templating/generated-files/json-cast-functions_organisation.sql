...
/*
NOTICE: This file is auto-generated using the script: apply-template.py organisation json-cast-functions.jinja.sql
*/
...
(
  ...
  rel as (
    ...
    (
      SELECT
      e.relType,
      array_agg( _json_object_delete_keys(row_to_json(ROW(e.relType,e.virkning,e.relMaalUuid,e.relMaalUrn,e.objektType)::OrganisationRelationType),ARRAY['reltype']::text[])) rel_json_arr
...
--drop cast (OrganisationRegistreringType as json);
...
--drop cast (OrganisationType as json);
