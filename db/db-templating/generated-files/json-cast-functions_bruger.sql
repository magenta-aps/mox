...
/*
NOTICE: This file is auto-generated using the script: apply-template.py bruger json-cast-functions.jinja.sql
*/
...
(
  ...
  rel as (
    ...
    (
      SELECT
      e.relType,
      array_agg( _json_object_delete_keys(row_to_json(ROW(e.relType,e.virkning,e.relMaalUuid,e.relMaalUrn,e.objektType)::BrugerRelationType),ARRAY['reltype']::text[])) rel_json_arr
...
--drop cast (BrugerRegistreringType as json);
