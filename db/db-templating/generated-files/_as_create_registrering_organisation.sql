...
/*
NOTICE: This file is auto-generated using the script: apply-template.py organisation _as_create_registrering.jinja.sql
*/
...
IF rows_affected=0 THEN
  RAISE EXCEPTION 'Error updating organisation with uuid [%], Invalid [livscyklus] transition to [%]',organisation_uuid,livscykluskode USING ERRCODE = 22000;
END IF;
