...
/*
NOTICE: This file is auto-generated using the script: apply-template.py facet json-cast-functions.jinja.sql
*/
...
(
  ...
  rel as (
    ...
    (
      SELECT
      e.relType,
      array_agg( _json_object_delete_keys(row_to_json(ROW(e.relType,e.virkning,e.relMaalUuid,e.relMaalUrn,e.objektType)::FacetRelationType),ARRAY['reltype']::text[])) rel_json_arr
...
--drop cast (FacetRegistreringType as json);
