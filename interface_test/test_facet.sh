...
curl -sH "Content-Type: application/json" -X GET $HOST_URL/klassifikation/facet?uuid=$uuid > /tmp/listoutput

# Search

curl -sH "Content-Type: application/json" -X GET "$HOST_URL/klassifikation/facet?redaktoerer=ddc99abd-c1b0-48c2-aef7-74fea841adae&redaktoerer=ef2713ee-1a38-4c23-8fcb-3c4331262194&status=Publiceret&brugervendtnoegle=ORGFUNK&plan=XYZ"

curl -sH "Content-Type: application/json" -X GET "$HOST_URL/klassifikation/facet?redaktoerer=ddc99abd-c1b0-48c2-aef7-74fea841adae&redaktoerer=ef2713ee-1a38-4c23-8fcb-3c4331262194&status=Publiceret&brugervendtnoegle=ORGFUNK&plan=XYZ&virkningFra=2000-01-01&virkningTil=2005-01-01"

curl -sH "Content-Type: application/json" -X GET "$HOST_URL/klassifikation/facet?redaktoerer=ddc99abd-c1b0-48c2-aef7-74fea841adae&redaktoerer=ef2713ee-1a38-4c23-8fcb-3c4331262194&status=Publiceret&brugervendtnoegle=ORGFUNK&plan=XYZ&virkningFra=2016-01-01&virkningTil=2018-01-01"

curl -sH "Content-Type: application/json" -X GET "$HOST_URL/klassifikation/facet?livscykluskode=Opstaaet&registreretFra=2016-01-01"

curl -sH "Content-Type: application/json" -X GET "$HOST_URL/klassifikation/facet?vilkaarligAttr=%funktion"

curl -sH "Content-Type: application/json" -X GET "$HOST_URL/klassifikation/facet?vilkaarligRel=ddc99abd-c1b0-48c2-aef7-74fea841adae"
