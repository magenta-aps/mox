...
# The activity log is for everything that isn't debug information. Only write
# single lines and no exception tracebacks here as it is harder to parse.
...
# The trace log contains debug statements (in context with everything higher
# precedens!) and is intended to be read by humans (tm) when something goes
# wrong. Please *do* write tracebacks and perhaps even pprint.pformat these
# messages.
