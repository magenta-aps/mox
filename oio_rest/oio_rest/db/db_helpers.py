...
from .db_structure import REAL_DB_STRUCTURE
...
def get_attribute_fields(attribute_name):
    ...
    if not _attribute_fields:
        ...
        for c, fs in REAL_DB_STRUCTURE.items():
...
def get_relation_field_type(class_name, field_name):
    class_info = REAL_DB_STRUCTURE[class_name.lower()]
...
def get_state_names(class_name):
    ...
    states = REAL_DB_STRUCTURE[class_name.lower()]['tilstande']
