...
:file:`oio_rest/oio_rest/default-settings.toml`. These can be overwritten by
...
.. py:data:: MOX_SYSTEM_CONFIG_PATH
    ...
    is to configure environments. We use it for docker.
...
This is the content of :file:`oio_rest/oio_rest/default-settings.toml`:
